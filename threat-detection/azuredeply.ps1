...
($resource = Get-AzureRmResource -ResourceId (Get-AzureRmKeyVault -VaultName "sql-mi-kv-dr2").ResourceId).Properties | Add-Member -MemberType "NoteProperty" -Name "enableSoftDelete" -Value "true" 
